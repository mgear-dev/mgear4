...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.dataCollector_checkBox.setToolTip(QtWidgets.QApplication.translate("Form", "<html><head/><body><p>Collected data will be stored in the root joint of the rig, if exist.</p><p>The root joint is the first joint created in the rig. Not necessary to be called &quot;root&quot;</p><p>If a path is provided the data will be also stored on an external JSON file</p></body></html>", None, -1))
        self.dataCollector_checkBox.setText(QtWidgets.QApplication.translate("Form", "Collect Data on External File", None, -1))
        ...
        self.dataCollectorEmbbeded_checkBox.setToolTip(QtWidgets.QApplication.translate("Form", "<html><head/><body><p>Collected data will be stored in the root joint of the rig, if exist.</p><p>The root joint is the first joint created in the rig. Not necessary to be called &quot;root&quot;</p><p>If a path is provided the data will be also stored on an external JSON file</p></body></html>", None, -1))
        self.dataCollectorEmbbeded_checkBox.setText(QtWidgets.QApplication.translate("Form", "Collect Data Embbeded on Root or custom joint (Warning: FBX Ascii format is not supported)", None, -1))
        self.dataCollectorEmbbeded_label.setText(QtWidgets.QApplication.translate("Form", "Custom Joint or Transform", None, -1))
        self.dataCollectorPathEmbbeded_pushButton.setText(QtWidgets.QApplication.translate("Form", "<<<", None, -1))
