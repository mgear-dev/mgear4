...
# Form implementation generated from reading ui file 'C:/datawork/repo/Shifter_MCS_components/components/GAMES_MCS_control_04/settingsUI.ui',
# licensing of 'C:/datawork/repo/Shifter_MCS_components/components/GAMES_MCS_control_04/settingsUI.ui' applies.
#
# Created: Mon Apr 11 11:30:02 2022
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        sizePolicy.setHeightForWidth(self.rbfLayers_spinBox.sizePolicy().hasHeightForWidth())
        ...
        self.rbfLayers_spinBox.setButtonSymbols(QtWidgets.QAbstractSpinBox.PlusMinus)
        ...
        self.ctlRotMult_doubleSpinBox = QtWidgets.QDoubleSpinBox(self.keyable_groupBox_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.ctlRotMult_doubleSpinBox.sizePolicy().hasHeightForWidth())
        ...
        self.ctlRotMult_doubleSpinBox.setButtonSymbols(QtWidgets.QAbstractSpinBox.PlusMinus)
        ...
        self.ctlSclMult_doubleSpinBox = QtWidgets.QDoubleSpinBox(self.keyable_groupBox_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.ctlSclMult_doubleSpinBox.sizePolicy().hasHeightForWidth())
        ...
        self.ctlSclMult_doubleSpinBox.setButtonSymbols(QtWidgets.QAbstractSpinBox.PlusMinus)
        ...
        self.ctlTransMult_doubleSpinBox = QtWidgets.QDoubleSpinBox(self.keyable_groupBox_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.ctlTransMult_doubleSpinBox.sizePolicy().hasHeightForWidth())
        ...
        self.ctlTransMult_doubleSpinBox.setButtonSymbols(QtWidgets.QAbstractSpinBox.PlusMinus)
        ...
        self.ctlTransMult_doubleSpinBox.setObjectName("ctlTransMult_doubleSpinBox")
    ...
    def retranslateUi(self, Form):
        ...
        self.leafJoint_checkBox.setToolTip(QtWidgets.QApplication.translate("Form", "<html><head/><body><p>When &quot;<span style=\" font-weight:600;\">is Leaf Joint</span>&quot; is checked, the component will create only the joint without the controls</p><p>As the name indicates this option is meant to create leaf joints, but you can use it also to create &quot;branches&quot;</p><p>Leaf joint can be used as a deformation helpers or/and games pipelines</p></body></html>", None, -1))
        self.leafJoint_checkBox.setText(QtWidgets.QApplication.translate("Form", "is Leaf Joint (Beta)", None, -1))
        ...
        self.rbfLayers_label.setText(QtWidgets.QApplication.translate("Form", "RBF Layers", None, -1))
        ...
        self.keyable_groupBox_2.setTitle(QtWidgets.QApplication.translate("Form", "Multipliers", None, -1))
        self.rbfLayers_label_3.setText(QtWidgets.QApplication.translate("Form", "CTL Rotate Mult", None, -1))
        self.rbfLayers_label_4.setText(QtWidgets.QApplication.translate("Form", "CTL Scale Mult", None, -1))
        self.ctlTransMult_label.setText(QtWidgets.QApplication.translate("Form", "CTL Translate Mult", None, -1))
