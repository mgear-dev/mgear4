...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        # self.gridLayout_5.addWidget(self.force_SSC_joints_checkBox, 3, 0, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        # self.force_SSC_joints_checkBox.setToolTip(gqt.fakeTranslate("Form", "<html><head/><body><p><span style=\" font-weight:600;\">WARNING: Only works in Maya 2020 or later</span></p><p>Use SSC (Segment Scale Compensation) NOTE: UE5 supports SSC, but Unity doesn\'t </p></body></html>", None, -1))
        # self.force_SSC_joints_checkBox.setText(gqt.fakeTranslate("Form", "Use SSC (Segment Scale Compensation) NOTE: UE5 supports SSC, but Unity doesn\'t ", None, -1))
