...
def get_plane_binormal(input1, input2, input3):
    """Returns the binormal vector of a triangle (Defined by 3 positions)
    ...
    Returns:
        maya.OpenMaya.MVector: 3D vector triangle binormal plane
    """

    # Get plane normal vector
    normal_vector = get_plane_normal(input1, input2, input3)
...
def get_plane_normal(input1, input2, input3):
    ...
    Returns:
        maya.OpenMaya.MVector: 3D vector triangle normal plane
    """
